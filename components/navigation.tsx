      ...
      <div className="container mx-auto px-6">
        <div className="flex items-center justify-between h-16">
          ...
          <Link href="/" className="flex items-center space-x-3">
            <svg width="60" height="60" viewBox="0 0 301 301" fill="none" xmlns="http://www.w3.org/2000/svg">
              <g clipPath="url(#nav_paint0_angular_109_2_clip_path)" data-figma-skip-parse="true">
              ...
              <path
                ...
                fill="url(#nav_paint0_angular_gradient)"
              />
              <path
                ...
                fill="url(#nav_paint1_linear_109_2)"
              />
              <path
              ...
              />
              <defs>
                <clipPath id="nav_paint0_angular_109_2_clip_path">
                ...
                <radialGradient
                  id="nav_paint0_angular_gradient"
                  cx="143.5"
                  cy="124"
                  r="98.5"
                  gradientUnits="userSpaceOnUse"
            ...
            <span className="text-xl font-bold" style={{ color: "#112A43" }}>
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link
              href="/asset/search"
              className={`text-sm font-medium transition-colors hover:text-blue-600 ${
                isActive("/asset") ? "text-blue-600" : "text-gray-700"
              }`}
            >
              Asset Analysis
            </Link>
